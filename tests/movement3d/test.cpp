...
TEST (movement3d_operator_plus_equal_no_fail, movement3d) {
    ...
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (1, 0)), 0.3);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (2, 0)), 0.5);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (0, 1)), 0.7);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (1, 1)), 0.9);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (2, 1)), 1.1);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (0, 2)), 1.3);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (1, 2)), 1.5);
    ASSERT_FLOAT_EQ (x1.rot_x ().at<float> (cv::Point (2, 2)), 1.7);
    // rot y
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (0, 0)), 0.1);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (1, 0)), 0.3);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (2, 0)), 0.5);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (0, 1)), 0.7);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (1, 1)), 0.9);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (2, 1)), 1.1);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (0, 2)), 1.3);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (1, 2)), 1.5);
    ASSERT_FLOAT_EQ (x1.rot_y ().at<float> (cv::Point (2, 2)), 1.7);
    // rot z
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (0, 0)), 0.1);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (1, 0)), 0.3);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (2, 0)), 0.5);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (0, 1)), 0.7);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (1, 1)), 0.9);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (2, 1)), 1.1);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (0, 2)), 1.3);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (1, 2)), 1.5);
    ASSERT_FLOAT_EQ (x1.rot_z ().at<float> (cv::Point (2, 2)), 1.7);

    ASSERT_FLOAT_EQ (x1.trans_x (), 3.2);
